...
__all__ = ['Bullet1', 'Bullet2', 'Bullet3', 'Bullet4', 'Boss_bullet_lv1', 'Boss_bullet_lv2', 'Boss_bullet_lv3']
...
class Bullet2(pygame.sprite.Sprite):
    def __init__(self, position, *args, **kw):
        ...
        self.image = pygame.image.load('images/bullet/bullet2.png').convert_alpha()
        self.mask = pygame.mask.from_surface(self.image)
...
class Bullet3(pygame.sprite.Sprite):
    def __init__(self, position, *args, **kw):
        ...
        self.image = pygame.image.load('images/bullet/bullet3.png').convert_alpha()
        self.mask = pygame.mask.from_surface(self.image)
...
class Bullet4(pygame.sprite.Sprite):
    def __init__(self, position, *args, **kw):
        ...
        self.image = pygame.image.load('images/bullet/bullet4.png').convert_alpha()
        self.mask = pygame.mask.from_surface(self.image)
